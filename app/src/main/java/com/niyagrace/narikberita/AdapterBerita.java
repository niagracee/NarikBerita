package com.niyagrace.narikberita;
...
import com.niyagrace.narikberita.response.BeritaItem;
...
public class AdapterBerita extends RecyclerView.Adapter<AdapterBerita.MyViewHolder> {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        // Dapatkan url gambar
        final String urlGambarBerita = "http://192.168.1.4/rest-api/simple-api-portal-berita-master/images/" + berita.get(position).getFoto();
